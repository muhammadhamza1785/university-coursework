...
HD_PWD='E:/DSD LAB/LAB 2/project_2_3bit/project_2_3bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ripple_Carry_Adder_3bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ripple_Carry_Adder_3bit.tcl

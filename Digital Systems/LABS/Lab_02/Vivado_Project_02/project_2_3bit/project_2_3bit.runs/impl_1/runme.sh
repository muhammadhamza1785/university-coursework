...
HD_PWD='E:/DSD LAB/LAB 2/project_2_3bit/project_2_3bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ripple_Carry_Adder_3bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ripple_Carry_Adder_3bit.tcl -notrace
